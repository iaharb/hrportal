...
const EmployeeDirectory: React.FC<EmployeeDirectoryProps> = ({ user, onAddClick }) => {
  ...
  return (
    <div className="space-y-10 animate-in slide-in-from-bottom-6 duration-700">
      ...
      <div className="bg-white rounded-[56px] border border-slate-100 shadow-sm overflow-hidden flex flex-col">
        {loading ? (
                  ...
                  {paginatedData.map((emp, idx) => {
                    ...
                    return (
                      <tr key={emp.id} className="hover:bg-slate-50/30 transition-colors group">
                        <td className="px-10 py-8 text-center text-xs font-black text-slate-300">
