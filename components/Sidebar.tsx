...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView, user, onLogout }) => {
  const allItems = [
    ...
    { id: View.Profile, label: 'My Workspace', icon: '👤', roles: ['Employee'] },
    { id: View.Leaves, label: 'Leave Hub', icon: '📅', roles: ['Admin', 'Manager', 'Employee'] },
    { id: View.Directory, label: 'Employee Directory', icon: '👥', roles: ['Admin', 'Manager'] },
    { id: View.Insights, label: 'AI Insights', icon: '✨', roles: ['Admin', 'Manager'] },
    { id: View.Compliance, label: 'PAM Compliance', icon: '⚖️', roles: ['Admin'] },
  ];
